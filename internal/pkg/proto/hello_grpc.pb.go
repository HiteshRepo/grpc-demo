...
type HelloServiceClient interface {
	// stream
	SayHello(ctx context.Context, in *HelloEmpty, opts ...grpc.CallOption) (HelloService_SayHelloClient, error)
}
...
func (c *helloServiceClient) SayHello(ctx context.Context, in *HelloEmpty, opts ...grpc.CallOption) (HelloService_SayHelloClient, error) {
	stream, err := c.cc.NewStream(ctx, &HelloService_ServiceDesc.Streams[0], "/hello.HelloService/SayHello", opts...)
	if err != nil {
		return nil, err
	}
...
type HelloServiceServer interface {
	// stream
	SayHello(*HelloEmpty, HelloService_SayHelloServer) error
...
func (UnimplementedHelloServiceServer) SayHello(*HelloEmpty, HelloService_SayHelloServer) error {
...
var HelloService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "internal/pkg/proto/hello.proto",
}
